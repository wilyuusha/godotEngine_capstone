...
## 						SCENES
## -----------------------------------------------------------------------------
onready var ChoiceButton = preload("res://addons/dialogic/Nodes/ChoiceButton.tscn")
onready var Portrait = preload("res://addons/dialogic/Nodes/Portrait.tscn")
onready var Background = preload("res://addons/dialogic/Nodes/Background.tscn")
...
#	if choice.text == "Correct Answer":
#		pass
#	else:
#		deduct_hp(10) # Deduct 10 HP if the answer is incorrect
